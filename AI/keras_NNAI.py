# Neural Networks with Keras & MNIST
...
#   Load MNIST: 70,000 handwritten digit image (28x28 pixels, grayscale)
...
model = keras.Sequential([
    ...
    keras.layers.Dropout(0.2),  # Randomly disable 20% neurons to prevent overfit
    keras.layers.Dense(256, activation='relu'),
    keras.layers.Dropout(0.2),
    keras.layers.Dense(10, activation='softmax')  # 10 output neurons for digits 0-9
])

model.summary() # See architecture: layers, shape, parameters
